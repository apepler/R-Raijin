...
plot_freq_panel<-function(year1,year2,seasons=rbind(c(5,10),c(11,4)),snames=c("MJJASO","NDJFMA"),year3,year4,cmip="ACCESS1-3",rcp="rcp85",
...
Fyears=seq(year3,year4,1)

fnames=c("ERAI_UM",paste0(cmip,"_historical_r1i1p1"),paste0(cmip,"_",rcp,"_r1i1p1"))
reanals=c(paste0("ERAI ",year1,"-",year2),
          paste0(cmip," hist ",year1,"-",year2),
          paste0(cmip," ",rcp," ",year3,"-",year4))
...
for(n in 1:3)
{
  a=nc_open(paste0(dir,"/",fnames[n],"_global",type,"s_",proj,type2,".nc"))
  ...
  for(s in 1:ss)
  {
   ...
   image(lon,lat,meanfreq,breaks=breaks,col=col1,xlab="",ylab="",
          main=paste0(snames[s]," ",type,"s: ",reanals[n]))
   map('world2',add=T)   
...
plot_freq_panel(1980,2005,year3=2071,year4=2100,
        seasons=rbind(c(5,10),c(11,4)),snames=c("MJJASO","NDJFMA"),
        dir="/short/eg3/asp561/cts.dir/gcyc_out/netcdf",
        cmip="ACCESS1-3",rcp="rcp85",
        type="cyclone",proj="proj100_rad5cv0.15",type2="_500km",
        fout="global_cycfreq_ERAI_ACCESS1-3_proj100_rad5cv0.15_500km")

#plot_freq_panel(1980,2005,year3=2071,year4=2100,
#        seasons=rbind(c(5,10),c(11,4)),snames=c("MJJASO","NDJFMA"),
#        dir="/short/eg3/asp561/cts.dir/gcyc_out/netcdf",
#        cmip="ACCESS1-3",rcp="rcp85",
#        type="cyclone",proj="proj100_rad2cv1",type2="_D2",
#        fout="global_cycfreq_ERAI_ACCESS1-3_proj100_rad2cv1_D2")
