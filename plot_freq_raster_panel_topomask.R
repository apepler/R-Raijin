...
a=nc_open("/g/data1/ub4/erai/netcdf/fx/ei_invariant_075x075_90N0E90S35925E.nc")
elat=ncvar_get(a,"latitude")
elon=ncvar_get(a,"longitude")
etopo=ncvar_get(a,"z")/9.80665
...
#   contour(lon,lat,meanfreq2,levels=breaks[seq(3,length(breaks),2)],add=T,lwd=2,col="black",drawlabels=F)
   ...
   image(elon,elat[length(elat):1],etopo[,length(elat):1],breaks=c(-1000,1000,10000000),col=c(rgb(0,0,0,0),rgb(0.7,0.7,0.7,1)),add=T)
   pnum=pnum+1
  }
}
...
plot_freq_panel(1980,2016,seasons=rbind(c(5,10),c(11,4)),snames=c("MJJASO","NDJFMA"),
        dir="/short/eg3/asp561/cts.dir/gcyc_out/netcdf",
        type="anticyclone",proj="proj100_rad10cv0.075",type2="_500km",
        fout="paperfig_anticycfreq_3reanals_proj100_rad10cv0.075_500km_Bu_ERAItopomask")
