...
if(month1==1 & month2==12) breaks=c(seq(0,1,0.1),1000) else breaks=c(seq(0,0.5,0.05),1000)
print("Plotting")
...
for(s in 1)
{
#plot_counts(1980,2014,dir="/short/eg3/asp561/cts.dir/gcyc_out/20CR/EnsMean/",anti="proj100_highs_rad10cv0.075",cyc="proj100_lows_rad5cv0.15",fout=paste("20CRmean_UM_meangen_1980-2014",seas[s],sep=""),month1=m1[s],month2=m2[s],dur=2)


plot_counts(1980,2016,dir="/short/eg3/asp561/cts.dir/gcyc_out/ERAI/",anti="proj100_highs_rad10cv0.075",cyc="proj100_lows_rad5cv0.15",fout=paste("ERAI_UM_meangen_1980-2016",seas[s],sep=""),month1=m1[s],month2=m2[s],dur=2)

#plot_counts(1980,2016,dir="/short/eg3/asp561/cts.dir/gcyc_out/NCEP1/",anti="proj100_highs_rad10cv0.075_v2",cyc="proj100_lows_rad5cv0.15_v2",fout=paste("NCEP1_UM_meangen_1980-2016",seas[s],sep=""),month1=m1[s],month2=m2[s],dur=2)
}
