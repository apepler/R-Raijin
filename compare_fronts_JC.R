...
if(cold)
{
a=nc_open(paste0(jdir,"cold_fronts_Aus",year,"_v2.nc"))
jc_front=ncvar_get(a,"systems")
} else {
...
{
jen_compare(years,winwid=3,len=3,cold=F,expandF=T,shiftR=T,daily=T,
     dir="/g/data/eg3/asp561/Fronts/",
     outf=paste0("frontcomp_cattoall_rudevalen3_plus6h_3deg_",years,"_daily.nc"))
}
