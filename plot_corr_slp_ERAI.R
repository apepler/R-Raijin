...
ColorBar(breaks,col1,subsampleg=2,vert=T)
dev.off()
}
...
plot_indcorr_panel(1980,2016,seasons=smons,snames=slist,
       ...
       fout=paste0("paperfig_anticyccorr_slp_ERAIpanel_proj100_rad10cv0.075_500km_2seasons.pdf"))


plot_indcorr_panel(1980,2016,seasons=smons2,snames=slist2,
       dir="/short/eg3/asp561/cts.dir/gcyc_out/ERAI/proj100_highs_rad5cv0.075/",
       type="high",closed=T,move=500,
       fout=paste0("paperfig_anticyccorr_slp_ERAIpanel_proj100_rad10cv0.075_500km_4seasons.pdf"))
