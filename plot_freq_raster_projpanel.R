...
plot_freq_panel<-function(year1,year2,seasons=rbind(c(5,10),c(11,4)),snames=c("MJJASO","NDJFMA"),
       ...
       type="cyclone",proj="proj100_rad5cv0.15",pnames="rad5cv0.15",fout="output")
{
...
plot_freq_panel(1980,2016,seasons=rbind(c(5,10),c(11,4)),snames=c("MJJASO","NDJFMA"),
        ...
        proj=c("proj100_rad10cv0.075_D2","proj100_rad10cv0.075_500km"),
        fout="paperfig_anticycfreq_ERAI_rad10cv0.075_threshcomp.pdf")

#plot_freq_panel(1980,2016,seasons=rbind(c(5,10),c(11,4)),snames=c("MJJASO","NDJFMA"),
#        dir="/short/eg3/asp561/cts.dir/gcyc_out/netcdf",
#        type="anticyclone",reanal="ERAI",pnames=c("rad10cv0.075","rad5cv0.075","rad5cv0.15"),
#        proj=c("proj100_rad10cv0.075_500km","proj100_rad5cv0.075_500km","proj100_rad5cv0.15_500km"),
#        fout="paperfig_anticycfreq_ERAI_projcomp_500km_v2.pdf")
