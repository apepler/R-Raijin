...
{ 
  ...
  date1=fixesDEC[,3]
  I=which(date1<100101)
  fixesDEC[I,3]=date1[I]+20000000
  I=which(date1>700101)
  fixesDEC[I,3]=date1[I]+19000000
  I=which(date1>=180101 & date1<=220101) # Over 1999/2000
  fixesDEC[I,3]=date1[I]+19800000
