...
for(year in 2005:2015) makegrid(year,dir="/short/eg3/asp561/cts.dir/gcyc_out/ERAI/proj100_lows_rad5cv0.15/",outf=paste0("austlows_5deg_proj100_rad5cv0.15_",year,".nc"),type="low",closed=T,lat=seq(-70,0,0.5),lon=seq(90,180,0.5),latlim=c(-50,-4),lonlim=c(110,161),winwid=5,widtype="deg",wincirc=T)
