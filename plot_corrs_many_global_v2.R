  ...
  for(j in 1:length(lat))
   for(em in 1:length(snames))
    for(k in 1:3)
     ...
     {
      a=cor.test(systems2[i,j,,em,k],index2,use="pairwise.complete.obs")
      cyccorr[i,j,em,k,1]=a$estimate
      cyccorr[i,j,em,k,2]=a$p.value      
      a=cor.test(diff(systems2[i,j,,em,k]),diff(index2),use="pairwise.complete.obs")
...
map('world2',add=T)
sigmask=which(apply(cyccorr[,,,k,2]<0.05,c(1,2),sum)==length(sdirs) & apply(meanfreq[,,,k],c(1,2),mean)>=5 & (apply(cyccorr[,,,k,1]<0,c(1,2),sum)==length(sdirs) | apply(cyccorr[,,,k,1]>0,c(1,2),sum)==length(sdirs)),arr.ind=T)
points(lon[sigmask[,1]],lat[sigmask[,2]],col="black",pch=19,cex=0.6)
...
for(s in 1)
    {
#  plot_corrs_many(1980,2014,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_lows_rad5cv0.15",fout=paste("UM_cyclonecorr_many_1980-2014_rad5cv15_D2",seas[s],sep=""),hilo="low",month1=m1[s],month2=m2[s],dur=2,inames=c("SOI","STRI","STRP","SAM","Hadley.SH","Hadley.AsiaPac"))

#  plot_corrs_many(1980,2014,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_highs_rad10cv0.075",fout=paste("UM_anticyclonecorr_many_1980-2014_rad10cv075_D2",seas[s],sep=""),hilo="high",month1=m1[s],month2=m2[s],dur=2,inames=c("SOI","STRI","STRP","SAM","Hadley.SH","Hadley.AsiaPac"))

#plot_corrs_many(1982,2014,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_lows_rad5cv0.15",fout=paste("UM_cyclonecorr_many_1982-2014_rad5cv15_D2",seas[s],sep=""),hilo="low",month1=m1[s],month2=m2[s],dur=2,inames=c("DMI"))

#plot_corrs_many(1982,2014,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_highs_rad10cv0.075",fout=paste("UM_anticyclonecorr_many_1982-2014_rad10cv075_D2",seas[s],sep=""),hilo="high",month1=m1[s],month2=m2[s],dur=2,inames=c("DMI"))

#  plot_corrs_many(1950,2014,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_lows_rad5cv0.15",fout=paste("UM_cyclonecorr_many_1950-2014_rad5cv15_D2",seas[s],sep=""),hilo="low",month1=m1[s],month2=m2[s],dur=2,inames=c("SOI","STRI","STRP"))

#  plot_corrs_many(1950,2014,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_highs_rad10cv0.075",fout=paste("UM_anticyclonecorr_many_1950-2014_rad10cv075_D2",seas[s],sep=""),hilo="high",month1=m1[s],month2=m2[s],dur=2,inames=c("SOI","STRI","STRP"))

#plot_corrs_many(1980,2014,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_lows_rad5cv0.15",fout=paste("UM_cyclonecorr_many_1980-2014_rad5cv15_D2",seas[s],sep=""),hilo="low",month1=m1[s],month2=m2[s],dur=2,inames=c("AOI","NAO","PNA"))

#plot_corrs_many(1980,2014,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_highs_rad10cv0.075",fout=paste("UM_anticyclonecorr_many_1980-2014_rad10cv075_D2",seas[s],sep=""),hilo="high",month1=m1[s],month2=m2[s],dur=2,inames=c("AOI","NAO","PNA"))

plot_corrs_many(1950,2010,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_lows_rad5cv0.15",fout=paste("UM_cyclonecorr_many_1950-2010_rad5cv15_D2",seas[s],sep=""),hilo="low",month1=m1[s],month2=m2[s],dur=2,inames=c("IPO","IPOf"))

plot_corrs_many(1950,2010,dir="/short/eg3/asp561/cts.dir/gcyc_out/",name="proj100_highs_rad10cv0.075",fout=paste("UM_anticyclonecorr_many_1950-2010_rad10cv075_D2",seas[s],sep=""),hilo="high",month1=m1[s],month2=m2[s],dur=2,inames=c("IPO","IPOf"))
