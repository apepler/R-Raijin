...
infile="UM_20CR_anticyclonestats_austregions2_proj100_rad10cv0.075_500km.RData"
outfile="UM_20CR_anticyclonestats_austregions2_proj100_rad10cv0.075_500km_fix.RData"

load(file=paste(dir,infile,sep=""))
stats=abind(stats,array(NaN,c(2,12,length(stypes),length(regnames),59)),along=1)

for(y in which(years>2014))
{
for(n in 58:59)
{
