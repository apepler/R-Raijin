...
storm_combo<-function(year,outf=NA,outdir="",fdir,fdirS,cdir,cdirS,tdir,lonlim=c(-180,180),latlim=c(-90,90),winwidF=0,winwidC=0,winwidT=0,cold=T,daily=F,TSenv=T,closed=T,cvthresh=0,len=0,shiftR=T,expandF=F)
{
...
#     tdir="/g/data/eg3/asp561/CattoData_20052015/",TSenv=F,
     ...
     outf=paste0("stormcombo_cattodowdysimmonds_TSenv_vic_",years,"_daily_v2.nc"))#,
